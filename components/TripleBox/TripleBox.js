...
const TripleBox = () => {
  return (
    <section className='w-3/4 mt-24 flex gap-6 justify-center'>

      <div className='w-1/3'>
        <LeftBox />
      </div>
      <div className='w-1/3 flex flex-col relative w-full justify-end bg-no-repeat bg-cover' style={{ backgroundImage: `url('midBox.svg')` }}>
