...
const Grids = () => {
  return (
    <section className=" mt-20 mb-12 border-t-[1px] border-[#262840]">
      <div className="flex flex-col text-center mb-10 mt-[100px]">
        <span className="uppercase text-base text-[#7780A1] mb-4 ">Overline</span>
      ...
      <div className="grid grid-cols-6 mx-[128px] justify-center mt-20 gap-6">
        <div>
          ...
          <div className="flex flex-row gap-2 items-center">
            ...
            <p className='text-white bg-purple-600 rounded-[4px] p-1 ml-[55px] mt-4'>2.55 ETH</p>
          </div>
        ...
        <div>
          ...
          <p className="text-white mt-4">Diam purus sagittis nisl erat mauris</p>
          <div className="flex flex-row gap-2 items-center">
            <ClockIcon className="h-5 w-5 text-white mt-4"/>
            <p className="text-white mt-4">22:59</p>
            <p className='text-white bg-purple-600 rounded-[4px] p-1 ml-[55px] mt-4'>2.55 ETH</p>
        ...
        <div>
          ...
          <p className="text-white mt-4">Nascetur mauris viverra vel id id sem leo</p>
          <div className="flex flex-row gap-2 items-center">
            <ClockIcon className="h-5 w-5 text-white mt-4"/>
            <p className="text-white mt-4">22:59</p>
            <p className='text-white bg-purple-600 rounded-[4px] p-1 ml-[55px] mt-4'>2.55 ETH</p>
        ...
        <div>
          ...
          <p className="text-white mt-4">Velit, fusce id non dui amet amet maecenas</p>
          <div className="flex flex-row gap-2 items-center">
            <ClockIcon className="h-5 w-5 text-white mt-4"/>
            <p className="text-white mt-4">22:59</p>
            <p className='text-white bg-purple-600 rounded-[4px] p-1 ml-[55px] mt-4'>2.55 ETH</p>
        ...
        <div>
          ...
          <p className="text-white mt-4">Tellus duis neque fringilla pulvinar gravida</p>
          <div className="flex flex-row gap-2 items-center">
            <ClockIcon className="h-5 w-5 text-white mt-4"/>
            <p className="text-white mt-4">22:59</p>
            <p className='text-white bg-purple-600 rounded-[4px] p-1 ml-[55px] mt-4'>2.55 ETH</p>
        ...
        <div>
          ...
          <p className="text-white mt-4">Odio lacus neque ultrices purus eget</p>
          <div className="flex flex-row gap-2 items-center">
            <ClockIcon className="h-5 w-5 text-white mt-4"/>
            <p className="text-white mt-4">22:59</p>
            <p className='text-white bg-purple-600 rounded-[4px] p-1 ml-[55px] mt-4'>2.55 ETH</p>
