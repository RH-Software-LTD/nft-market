        ...
        <div className={styles.container}>
          <div className={styles.info}>
            ...
            <div className="text-white flex flex-row mt-12 w-full gap-4 text-center items-center">
              <a
                className="text-white whitespace-nowrap rounded-xl bg-[#4745D0] p-3 shadow-lg purple-button"
                href="#"
              >
                Get started
              </a>
              <a
                className="text-gray-600 whitespace-nowrap  border-gray-500 border-[1px] p-3 rounded-xl border-opacity-30"
                href="#"
              >
                Learn more
              </a>
          ...
          <div
            ...
            style={{ backgroundImage: `url('Users.svg')` }}
          ></div>
        </div>
      </div>
    </section>
